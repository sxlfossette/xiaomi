<template>
   <div class="index">
           ...
           <div class="list-box">
             <div class="list" v-for="(arr,i) in phoneList" :key="i">
               <div class="item" v-for="(item,j) in arr" :key="j">
                 <span v-bind:class="{'new-pro':j%2==0,'kill-pro':j%2==1}">{{j%2==0?'新品':'秒杀'}}</span>
                 <div class="item-img">
     ...
     <!-- 由于modal不是标签而是组件，不能用click的方式来定义事件，因此用子组件传的名称(submit)来定义 -->
...
.index{
  .swiper-box{
    .nav-menu{
      ...
      box-sizing: border-box;//指定盒模型后高度包括padding值
      .menu-wraper{
        .menu-item{
          height: 50px;
          line-height: 50px;
